...
public class ProductDetailsActivity extends AppCompatActivity {
    ...
    private void addingToCartList()
    {
        ...
        cartListRef.child("User View").child(usName[0])
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        ...
                        {
                            cartListRef.child("Admin View").child(usName[0])
                                    .child("Products").child(productID)
                                    .updateChildren(cartMap)
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
        ...
        productsRef.child(productID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.exists())
                {
                    ...
                    productName.setText(products.getPdtname());
    ...
    private void CheckOrderState()
    {
        ...
        ordersRef = FirebaseDatabase.getInstance().getReference().child("Orders").child(usName[0]);
